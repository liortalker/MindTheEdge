...
from packnet_code.packnet_sfm.utils.image import flip_lr, interpolate_scales
from packnet_code.packnet_sfm.utils.misc import filter_dict
from packnet_code.packnet_sfm.utils.types import is_tensor, is_list, is_numpy
...
def flip_batch_input(batch):
    ...
    for key in filter_dict(batch, [
        'rgb', 'rgb_context',
        'input_depth', 'input_depth_context', 'rgb_edge'
    ]):
