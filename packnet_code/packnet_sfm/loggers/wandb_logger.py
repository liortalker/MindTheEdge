...
from packnet_code.packnet_sfm.utils.depth import viz_inv_depth
from packnet_code.packnet_sfm.utils.logging import prepare_dataset_prefix
from packnet_code.packnet_sfm.utils.types import is_dict, is_tensor
...
class WandbLogger:
    ...
    def run_url(self) -> str:
        """Returns run URL."""
        return 'https://wandb.transchip.com/{}/{}/runs/{}'.format(
    ...
    def log_metrics(self, metrics, force_log=False):
        """Logs training metrics."""
        self._metrics.update(metrics)
        if force_log or 'global_step' in metrics:
