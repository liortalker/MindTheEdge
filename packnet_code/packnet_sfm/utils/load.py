...
from packnet_code.packnet_sfm.utils.misc import make_list, same_shape
from packnet_code.packnet_sfm.utils.logging import pcolor
from packnet_code.packnet_sfm.utils.horovod import print0
from packnet_code.packnet_sfm.utils.types import is_str
...
def load_class(filename, paths, concat=True):
    ...
    for path in make_list(paths):
        ...
        if not full_path.split('.')[0] == 'packnet_code':
            full_path = 'packnet_code.' + full_path
