...
from packnet_code.packnet_sfm.utils.image import write_image
from packnet_code.packnet_sfm.utils.depth import write_depth, inv2depth, viz_inv_depth
from packnet_code.packnet_sfm.utils.logging import prepare_dataset_prefix

def save_paths_list(paths, out_path, file_name):
